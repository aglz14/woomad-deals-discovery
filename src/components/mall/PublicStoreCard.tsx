...
export const PublicStoreCard = ({
  ...
  return (
    <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer bg-white" onClick={onClick}>
      <CardHeader className="text-left">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <CardTitle className="text-lg font-semibold line-clamp-1 text-left">
              {store.name}
            </CardTitle>
